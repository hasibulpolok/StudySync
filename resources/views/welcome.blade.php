...
<header class="nav-header header-layout1">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-2">
          <div class="logo-img">
            <a href="index.html">
              <img src="assets/img/logo/Logo.svg" alt="edupls-icon" />
            </a>
          ...
          <div class="nav-middle-content">
            <div class="content-location">
              ...
              <div class="info-data">
                ...
                <p class="para text">Marina Lane Berlin</p>
              </div>
            </div>
            <div class="content-address">
              ...
              <div class="info-data">
                ...
                <p class="para text">learn@edupls.com</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-auto">
              <div class="menu-area-right-content">
                <ul class="menu-social">
                  <li>
                    <a href="#"><i class="my-icon icon-facebook"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="my-icon icon-instagram"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="my-icon icon-twitter"></i></a>
                  </li>
                </ul>
                <div class="menu-contact-number">
                  <a href="#" class="contact-number">+259 (0) 256 215</a>
                </div>
                <div class="all-btn">
  ...
  <div class="mobile-menu-wrapper">
    <div class="mobile-menu-area text-center">
      ...
      <div class="mobile-logo">
        <a href="index.html"><img src="assets/img/logo/Logo.svg" alt="Edupls-icon" /></a>
      </div>
    ...
    <div class="container-lg">
        <div class="section-title center">
            <div class="section-title-inner center w-v2">
                ...
                <h2 class="big-title s-color-black" data-aos="fade-up" data-aos-duration="1000">Why People Choose Us?
                </h2>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div class="case-studies-card" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                        ...
                        <div class="card-content">
                            ...
                            <a href="login.html" class="btn-p v6">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
          ...
          <div class="about-right-content">
            ...
            <ul class="awards">
              <li data-aos="fade-left" data-aos-duration="1000">
                <div class="award-img">
                  <img
                    src="assets/img/about-us/award-img-1.jpg"
                    alt="award-img"
                  />
                </div>
              ...
              <li data-aos="fade-left" data-aos-duration="1000">
                <div class="award-img">
                  <img
                    src="assets/img/about-us/award-img-2.jpg"
                    alt="award-img"
                  />
                </div>
                <div class="award-content">
            ...
            <div class="play-data v2" data-aos="fade-left" data-aos-duration="1000">
              <div class="all-btn">
                <a href="contact.html" class="btn-p v1 btn-blue icon-v1 rounded"
                  >MORE ABOUT US</a
                >
              </div>
              <a
                href="https://www.youtube.com/watch?v=pCuanWbgUt8"
                class="youtube"
              >
                <div class="play-content">
                  <div class="play-icon">
  ...
  <div class="container-lg">
    <div class="section-title center">
      <div class="section-title-inner center">
        ...
        <h2 class="big-title s-color-white" data-aos="fade-up" data-aos-duration="1000">Our Most popular Courses</h2>
      </div>
    </div>
    <div class="courses-cards v1">
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button class="nav-link" id="nav-design-tab" data-bs-toggle="tab" data-bs-target="#nav-design" type="button"
          ...
          <button class="nav-link" id="nav-seo-tab" data-bs-toggle="tab" data-bs-target="#nav-seo" type="button"
            role="tab" aria-controls="nav-seo" aria-selected="false">
            Seo
          </button>
          <button class="nav-link" id="nav-marketing2-tab" data-bs-toggle="tab" data-bs-target="#nav-marketing2"
            type="button" role="tab" aria-controls="nav-marketing2" aria-selected="false">
            Marketing
          </button>

          <button class="nav-link" id="nav-agency-tab" data-bs-toggle="tab" data-bs-target="#nav-agency" type="button"
            role="tab" aria-controls="nav-agency" aria-selected="false">
            Agency
          </button>
          <button class="nav-link" id="nav-creative-tab" data-bs-toggle="tab" data-bs-target="#nav-creative"
            type="button" role="tab" aria-controls="nav-creative" aria-selected="false">
            Creative
          </button>
        </div>
      </nav>
              ...
              <div class="courses-cards-content" data-name="marketing">
                ...
                <div class="courses-content">
                  ...
                  <h4 class="courses-title">
                    <a href="courses-details.html">Mastering Foreign Languages Spanish, Business and
                      Communication
                    </a>
                  </h4>
                  <div class="time-leson">
                    <div class="time">
                      <div class="time-icon"><i class="my-icon icon-time-hour"></i></div>4 hour 31min
                    </div>
                    <div class="leson">
                      <div class="leson-icon"><i class="my-icon icon-lesson"></i></div>20 Lesson
                    </div>
                  </div>
                </div>
                <div class="admin">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
              <div class="courses-cards-content" data-name="design">
                ...
                <div class="courses-content">
                  ...
                  <h4 class="courses-title">
                    <a href="courses-details.html">Navigating the World of Chemistry are Education Through
                      Elements</a>
                  </h4>
                  <div class="time-leson">
                    <div class="time">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
              <div class="courses-cards-content" data-name="Seo">
                ...
                <div class="courses-content">
                  ...
                  <h4 class="courses-title">
                    <a href="courses-details.html">A Comprehensive Guide to Unleashing the Power of
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
              <div class="courses-cards-content" data-name="marketing">
                ...
                <div class="courses-content">
                  ...
                  <h4 class="courses-title">
                    <a href="courses-details.html">Charting the Landscape of Biology Hub for Learning Life
                      Sciences etc</a>
                  </h4>
                  <div class="time-leson">
                    <div class="time">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
              <div class="courses-cards-content" data-name="design">
                ...
                <div class="courses-content">
                  ...
                  <h4 class="courses-title">
                    <a href="courses-details.html">Riding the Currents of Physics Education Through Physics
                      Excellence</a>
                  </h4>
                  <div class="time-leson">
                    <div class="time">
  ...
  <div class="courses-bg-right">
    ...
    <div class="cta-bg-right-img">
        <img src="assets/img/cta/cta-bg-right-img.png" alt="bg-right-img">
    </div>
    <div class="cta-bg-left-img">
        <img src="assets/img/cta/cta-bg-left-img.png" alt="bg-left-img">
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xl-6">
          <div class="choose-us-right-content">
            <div class="section-title">
              <div class="section-title-inner">
                <h4 class="sub-title" data-aos="fade-down" data-aos-duration="1500">Why Choose Us?</h4>
                <h2 class="big-title" data-aos="fade-up" data-aos-duration="1500">Frequently Ask Question?</h2>
                <p class="title-para sp-color-black" data-aos="fade-up" data-aos-duration="1500">Teachers play a
                  critical role in education by instructing and guiding for students,
                  facilitating learning, providing support and encouragement, and fostering a positive</p>
              </div>
            </div>
              ...
              <li class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    ...
                    <span class="button-number">01</span>What are the different levels of education?
                  </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    Education is important for personal and societal growth, enhancing critical thinking, expanding
                    knowledge and skills, improving career prospects, and promoting social and best Scholl &amp; collage
                  </div>
                </div>
              </li>
              ...
              <li class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <span class="button-number">03</span>How can I choose the educational institution or program?
                  </button>
                </h2>
                ...
                <div class="col-lg-5">
                    <div class="feedback-left-content">
                        <div class="feedback-left-img" data-aos="zoom-in-up" data-aos-duration="2000">
                            <img src="assets/img/student-feedback/feedback-big-img.jpg" alt="feedback-big-img">
                        </div>
    ...
    <div class="container">
        <div class="section-title center">
            <div class="section-title-inner center">
                ...
                <h2 class="big-title s-color-white" data-aos="fade-up" data-aos-duration="1500">Register Now & Get Free
                    Courses Online</h2>
            </div>
        </div>
                    ...
                    <div class="case-studies-left-content">
                        <div class="section-title">
                            <div class="section-title-inner">
                                ...
                                <h2 class="big-title s-color-black" data-aos="fade-up" data-aos-duration="1500">Periodically follow up scholl demonstrate progress,</h2>
                            </div>
                        </div>
                        <ul class="case-studies-contents">
                            <li class="case-content" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <div class="content-data">
                                    <h3 class="title"><a href="event-details.html">Embark empowerment<span class="my-icon icon-arrow-right-top"></span></a></h3>
                                    <p class="para">These refined sub-menu options offer a comprehensive breakdown of various educational areas students
                                    </p>
                                </div>
                            </li>
                            <li class="case-content" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <div class="content-data">
                                    <h3 class="title"><a href="event-details.html">Education empowering learne<span class="my-icon icon-arrow-right-top"></span></a></h3>
                                    <p class="para">These refined sub-menu options offer a comprehensive breakdown of various educational areas students
                                    </p>
                                </div>
                            </li>
                            <li class="case-content" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <div class="content-data">
                                    <h3 class="title"><a href="event-details.html">Our platform caters to need<span class="my-icon icon-arrow-right-top"></span></a></h3>
                                    <p class="para">These refined sub-menu options offer a comprehensive breakdown of various educational areas students
                                    </p>
                                </div>
                            </li>
  ...
  <div class="container">
    <div class="section-title v2">
      <div class="section-title-inner w-v2">
          ...
          <h2 class="big-title s-color-black" data-aos="fade-up" data-aos-duration="1500">Our Lest News & Blog education Details</h2>
      </div>
          ...
          <div data-aos="fade-left" data-aos-duration="1500">
            <div class="card-content-2">
              ...
              <div class="content-data">
                ...
                <h3 class="big-title"><a href="blog-details.html">Beyond the Classroom Explorin for Educational Horizons</a></h3>
                  <p class="para">Education is a crucial field of study, as it helps us understand the impact of human </p>
                </div>
              </div>
          </div>
          <div data-aos="fade-left" data-aos-duration="1500">
            <div class="card-content-3">
              ...
              <div class="content-data">
                ...
                <h3 class="big-title"><a href="blog-details.html">Empowering Minds Navigating the Landscape of Education</a></h3>
                <p class="para">Education is a crucial field of study, as it helps us understand the impact of human </p>
            </div>
          </div>
          </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="footer-widget">
            ...
            <ul class="footer-social-link">
              ...
              <li>
                <a href="#">
                  <i class="my-icon icon-discord"></i>
                </a>
              </li>
              <li>
                <a href="#">
